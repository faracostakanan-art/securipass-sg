          ...
          <CardContent className="p-8 space-y-6">
            ...
            <div className="text-center space-y-4">
              <p className="text-lg text-gray-700 leading-relaxed">
                Merci d'avoir complété votre demande de mise à jour Securipass.
              </p>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-gray-700 text-base leading-relaxed">
                      Un conseiller vous contactera dans les <strong>24 à 48 heures</strong> pour finaliser la mise à jour de votre Securipass et vérifier vos informations.
                    </p>
                  </div>
                </div>
              </div>
