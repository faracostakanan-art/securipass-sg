// Mock data for Securipass application
...
export const updateSteps = [
  ...
  },
  {
    id: 4,
    title: 'Confirmation',
    description: 'Validation et activation de votre nouveau Securipass',
    status: 'pending'
  }
];
...
export const faqData = [
  {
    id: 1,
    question: 'Pourquoi dois-je mettre à jour mon Securipass ?',
  ...
  {
    id: 2,
    question: 'Quels sont les critères pour un Securipass sécurisé ?',
    answer: 'Votre nouveau Securipass doit contenir au moins 12 caractères, incluant des majuscules, minuscules, chiffres et caractères spéciaux. Évitez les informations personnelles facilement identifiables.'
  },
  {
    id: 3,
    question: 'Que faire si j\'ai oublié mon ancien Securipass ?',
  ...
  },
  {
    ...
    answer: 'Oui, pour garantir la sécurité de tous nos clients, cette mise à jour est obligatoire avant le 31 décembre 2025. Après cette date, l\'accès avec l\'ancien Securipass ne sera plus possible.'
  },
  {
    id: 5,
...
export const updatePassword = (userId, oldPassword, newPassword) => {
  return new Promise((resolve, reject) => {
    setTimeout(() => {
      ...
      resolve({
        success: true,
        message: 'Votre Securipass a été mis à jour avec succès.'
      });
    }, 1500);
  });
};
